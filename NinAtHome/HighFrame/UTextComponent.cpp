    ...
    mKanaUV({})
{
    ...
    mKanaUV.insert(std::make_pair(
        "ぁ", MakeFloat3(0.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ぃ", MakeFloat3(1.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ぅ", MakeFloat3(2.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ぇ", MakeFloat3(3.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ぉ", MakeFloat3(4.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));

    mKanaUV.insert(std::make_pair(
        "っ", MakeFloat3(17.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));

    mKanaUV.insert(std::make_pair(
        "ゃ", MakeFloat3(16.0f * MOJI_U, 6.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ゅ", MakeFloat3(17.0f * MOJI_U, 6.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ょ", MakeFloat3(18.0f * MOJI_U, 6.0f * MOJI_V, 0.7f)));

    mKanaUV.insert(std::make_pair(
        "ゎ", MakeFloat3(5.0f * MOJI_U, 7.0f * MOJI_V, 0.7f)));

    mKanaUV.insert(std::make_pair(
        "ァ", MakeFloat3(0.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ィ", MakeFloat3(1.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ゥ", MakeFloat3(2.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ェ", MakeFloat3(3.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ォ", MakeFloat3(4.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));

    mKanaUV.insert(std::make_pair(
        "ッ", MakeFloat3(17.0f * MOJI_U, 5.0f * MOJI_V, 0.7f)));

    mKanaUV.insert(std::make_pair(
        "ャ", MakeFloat3(16.0f * MOJI_U, 6.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ュ", MakeFloat3(17.0f * MOJI_U, 6.0f * MOJI_V, 0.7f)));
    mKanaUV.insert(std::make_pair(
        "ョ", MakeFloat3(18.0f * MOJI_U, 6.0f * MOJI_V, 0.7f)));

    mKanaUV.insert(std::make_pair(
        "ヮ", MakeFloat3(5.0f * MOJI_U, 7.0f * MOJI_V, 0.7f)));
}
